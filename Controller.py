...
class Controller:
    ...
    def click_btn_new(self):
        ...
        self.model.start_new_game()  # start a new game
    ...
    def click_btn_send(self):
        ...
        self.view.lbl_result.configure(text=self.model.user_word)  # Changed the underscores????
        ...
        if self.model.counter > 0:
            self.view.lbl_error.configure(fg='red')  # Font colour
